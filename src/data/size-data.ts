...
export const SIZE_MARKETS: Market[] = [
  { id: 'cpg', n: '01', name: 'Consumo masivo', sub: 'CPG',
    ...
    theme: { primary: '#FF5A1F', secondary: '#FFD93D', bg: '#FFF8E7', ink: '#1A1A1A', display: "'Geist',sans-serif", body: "'Geist',sans-serif" },
  ...
  { id: 'banca', n: '02', name: 'Banca y servicios financieros', sub: 'Finance',
    ...
    theme: { primary: '#0A2540', secondary: '#C9A961', bg: '#F4F1EA', ink: '#0A2540', display: "'Instrument Serif',serif", body: "'Geist',sans-serif" },
  ...
  { id: 'retail', n: '03', name: 'Retail', sub: 'Retail',
    ...
    theme: { primary: '#E60023', secondary: '#000000', bg: '#FFFFFF', ink: '#0A0A0A', display: "'Archivo Black',sans-serif", body: "'Geist',sans-serif" },
  ...
  { id: 'salud', n: '05', name: 'Salud y farma', sub: 'Health',
    ...
    theme: { primary: '#1B6CA8', secondary: '#7DC9E7', bg: '#F8FAFB', ink: '#0F2A3F', display: "'Geist',sans-serif", body: "'Geist',sans-serif" },
  ...
  { id: 'inmobiliario', n: '07', name: 'Inmobiliario y construcción', sub: 'Real Estate',
    ...
    theme: { primary: '#3A3A3A', secondary: '#B8A88A', bg: '#EFECE6', ink: '#1F1F1F', display: "'Instrument Serif',serif", body: "'Geist',sans-serif" },
  ...
  { id: 'educacion', n: '08', name: 'Educación', sub: 'Edu',
    ...
    theme: { primary: '#2E5BFF', secondary: '#FFB800', bg: '#FBFBFD', ink: '#0F1B3D', display: "'Geist',sans-serif", body: "'Geist',sans-serif" },
  ...
  { id: 'turismo', n: '09', name: 'Turismo y hospitalidad', sub: 'Travel',
    ...
    theme: { primary: '#0E7C7B', secondary: '#F4A261', bg: '#F1EDE3', ink: '#1A2E2E', display: "'Instrument Serif',serif", body: "'Geist',sans-serif" },
    services: ['estrategia', 'branding', 'diseno', 'audiovisual', 'web', 'seo', 'performance', 'social'] },
  ...
  { id: 'moda', n: '11', name: 'Moda y belleza', sub: 'Fashion',
    ...
    theme: { primary: '#000000', secondary: '#D4A1A1', bg: '#F5EFE8', ink: '#0A0A0A', display: "'Instrument Serif',serif", body: "'Geist',sans-serif" },
  ...
  { id: 'startups', n: '12', name: 'Fintech, D2C y Startups', sub: 'Startups',
    ...
    theme: { primary: '#7C3AED', secondary: '#10B981', bg: '#FAFAFA', ink: '#0F0F0F', display: "'Geist',sans-serif", body: "'Geist',sans-serif" },
